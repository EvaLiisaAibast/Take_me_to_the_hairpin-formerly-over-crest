...
| Career | World | Routes |
|---|---|---|
| CLASSIC WRC — “THE SEAT” | Cockpit (WRC) | Male co-driver · Female co-driver (same story, different scenes) |
| MIDNIGHT CLASS — Street / Wangan | Street (neon Yokohama) | Male co-driver · Female co-driver (same story, different scenes) |
| DUST AND HONOR — Dakar / Roadbook | Roadbook (sand & diesel) | Male co-driver · Female co-driver (same story, different scenes) |

**Stats tracked by choices:** Driver Trust · Team Respect · Mental Stress · Grit · Reputation · Legacy.

---

# CLASSIC WRC — “THE SEAT”

*Theme: Cockpit (WRC)*

**Cast:** You (navigator) · Mikko Lahti (driver) · Marcus Webb (rival) · Laurent (team principal) · Elena (partner)

## Route: MALE CO-DRIVER

### Intro

They expect you to be the voice of reason.
...
#### Before the stage · scene 1 — SERVICE PARK · THE TRAILER · 22:00

**NARRATOR:** Mikko is leaning against the fender of the car. He's holding a flask. The air smells like cheap brandy and expensive racing fuel. He isn't taping his wrists; he's staring at a dent he made in testing. The dent is shaped like a memory he's trying to forget.

**MIKKO:** Car's pushing wide. Or maybe the world's moving too fast today. Every time you call a note perfectly, it costs me something. Trust is expensive. You ready to pay that price, or just here for the ride?

**Choices:**

1. **"I'm not here to judge. I'm here to keep you alive."**
   → Mikko: (studies you, then hands over the flask)
   ...
   _stats: driverTrust +15 · teamRespect +5 · mentalStress -5_
2. **"If trust is expensive, then let's make it worth it."**
   → Mikko: (takes a drink, then another)
   ...
   _stats: driverTrust +5 · mentalStress +10_
3. **"The price of trust is what you pay it. Not what it costs you."**
   → Mikko: (laughs, genuinely surprised)
   ...
   _stats: driverTrust +10 · reputation +5 · mentalStress +5_

#### Before the stage · scene 2 — BEHIND THE SERVICE TENT

**NARRATOR:** She corners you behind the service tent. She looks like she hasn't slept. Not because she's angry—because she's been running the numbers for three years and getting the same result.

**GIRLFRIEND:** He's shaking. Did you see his hands? He's drinking because the last time he drove sober, the car came back but he didn't. Not entirely. I'm not threatening you. I'm telling you what I've already paid.

**YOU:** What do you want me to do?

**GIRLFRIEND:** I don't want anything. That's not how this works. I ran the numbers once, accepted the cost, and now I live with it. You're running them too. I'm just telling you: the price you pay isn't always the one you see on the receipt.

**Choices:**

1. **"I'll keep him alive. That's the only number that matters."**
   → Girlfriend: (nods, not in agreement but in recognition)
   ...
   _stats: driverTrust +10 · teamRespect +5 · mentalStress +5_
2. **"What was the last co-driver's mistake?"**
   → Girlfriend: (looks at you like you've asked the only question that matters)
   ...
   _stats: driverTrust +15 · reputation +5 · mentalStress +10_
3. **"You're not asking me to save him. You're asking me to save yourself."**
   → Girlfriend: (doesn't flinch)
   ...
   _stats: driverTrust +5 · reputation +10 · mentalStress -5_

#### Before the stage · scene 3 — SERVICE BAY

**NARRATOR:** Jorge doesn't look up from the suspension arm he's adjusting. He's been here since before Group B was called Group B, before the cars were monsters, before the drivers were ghosts.

**JORGE:** Suspension's within spec. Driver's got a misfire.
...
**JORGE:** I'm a mechanic, not a priest. And even if I were a priest, I couldn't fix something that doesn't want to be fixed.
...
1. **"Machines don't have a choice. He does."**
   → Jorge: (stops working, torque wrench mid-turn)
   ...
   _stats: driverTrust +10 · teamRespect +15 · mentalStress -10_
2. **"You've seen this before. What did the last co-driver do wrong?"**
   → Jorge: (sets down his wrench)
   ...
   _stats: driverTrust +5 · teamRespect +10 · mentalStress +5_
3. **"Then let him make his choice. I'll just call the notes."**
   → Jorge: (nods, not in agreement but in respect)
   ...
   _stats: teamRespect +5 · reputation +5_
4. **[Engineering] The dampers are too stiff for his state. Let me adjust them.**
   → Jorge: (looks up, genuinely interested)
   ...
   _stats: driverTrust +15 · teamRespect +20 · mentalStress -15_

#### Before the stage · scene 4 — SERVICE BAY · EARLY MORNING

**NARRATOR:** Jorge is already there when you arrive, coffee in one hand, torque wrench in the other. The car looks better than it has all season.

**JORGE:** Payroll. Proper procurement. That's new.

**YOU:** You keep him alive. Seemed like a good investment.

**JORGE:** Three seasons of suspension rebuild on my own time. Now I get proper parts, proper hours.
...
1. **"That's all I needed to hear."**
   → Jorge nods once, satisfied, returns to the bench. Engine fires on first crank — hasn't done that all season.
   _stats: driverTrust +5 · mentalStress -5_

#### Before the stage · scene 5 — FACTORY MOTORHOME · PRIVATE SUITE

**NARRATOR:** The factory team recruiter doesn't look like a racing person. He looks like someone who buys racing teams. The suit costs more than your car.

**RECRUITER:** We've been watching you. Not Mikko — you. The way you handle him, the way you call notes, the way you manage the chaos. That's not something we can buy. That's something we have to recruit.

**YOU:** I'm not looking to leave. We're building something here.

**RECRUITER:** Building. Passionate word. Privateer word.
...
1. **"What's the catch?"**
   → Recruiter: (smiles, appreciates the directness)
   ...
   _stats: reputation +10_
2. **"I don't sell my loyalty. I earn it."**
   → Recruiter: (doesn't flinch)
   ...
   _stats: reputation +5 · grit +10_
3. **"Tell me about the drivers you have in mind."**
   → Recruiter: (genuinely pleased)
   ...
   _stats: reputation +15_

#### Before the stage · scene 6 — PRIVATEER GARAGE · LATE NIGHT

**NARRATOR:** The privateer garage is empty except for one mechanic working under a single light. He's using parts that don't match — factory cast-offs welded together with creativity and desperation.

**MECHANIC:** Heard you talked to the factory rep. They come around every season, poaching anyone who shows promise. Like locusts in suits.

**YOU:** I didn't say yes.

**MECHANIC:** Didn't say no either, I bet.
...
1. **"What happens to this team if I leave?"**
   → Mechanic: (stops working, finally looks at you)
   ...
   _stats: reputation +5 · mentalStress +10_
2. **"Show me what you're building. With nothing."**
   → Mechanic: (grins, genuine)
   ...
   _stats: teamRespect +15 · reputation +10_
3. **"Desperation isn't a business model."**
   → Mechanic: (doesn't argue)
   ...
   _stats: reputation +5_

#### After the stage · scene 1 — SERVICE PARK

**NARRATOR:** After a messy stage where Mikko clipped a wall. The damage is cosmetic but the silence between them isn't.

**GIRLFRIEND:** He said you were late on the hairpins. He said the intercom was fuzzy.



She doesn't look angry. She looks like someone who's seen this pattern before and knows how it ends.

**YOU:** The notes were right. He was carrying too much speed for the entry.

**GIRLFRIEND:** I'm not saying you're wrong. I'm saying that being right doesn't change the wall.
...
**GIRLFRIEND:** I'm not attacking him. I'm telling you what the numbers look like from outside.
...
1. **"The notes were early. I called them right. He's the one who has to trust them."**
   → Mikko looks at you. There's something in his eyes—not shame, not respect, but recognition.
   ...
   _stats: driverTrust +15 · reputation +5_
2. **"You're both right. The notes don't matter if the driver won't listen."**
   → Elena studies you, surprised.
   ...
   _stats: driverTrust +10 · teamRespect +5 · mentalStress -5_
3. **(Stay silent)**
   → The silence hangs heavy. Mikko looks away. Elena doesn't smile—she just looks tired.
   ...
   _stats: driverTrust -5 · reputation -5 · mentalStress +15_

#### After the stage · scene 2 — COFFEE MACHINE

**NARRATOR:** Laurent doesn't look like a rival. He looks like someone who's been watching the same pattern repeat for ten years and is tired of pretending not to see it.

**LAURENT:** You're the one sitting next to Mikko.



He doesn't say it with malice. He says it like it's a fact he's checking.

**YOU:** I'm the one keeping him ahead of you.
...
1. **"Then why do you care?"**
   ...
   _stats: reputation +10 · mentalStress +5_
2. **"I notice everything. Including that you're not actually racing him."**
   → Laurent: (smiles, not in mockery but in respect)
   ...
   _stats: reputation +15 · driverTrust +5_
3. **"What happened to the last co-driver who noticed too much?"**
   → Laurent: (doesn't flinch)
...
#### After the stage · scene 3 — SERVICE PARK · EVENING

**NARRATOR:** Jorge and Elena are arguing near the car. Not shouting—this is worse. This is the kind of quiet argument that's been happening for months.

**JORGE:** Car's ready. Setup's within tolerance. If he drives the spec I built, he wins.

**ELENA:** He won't drive it the way you built it. He'll drive it the way he always drives—too fast, too early, trusting the car to save him.

**JORGE:** Then he shouldn't be in the cockpit.

**ELENA:** That's your solution? Retirement? What about the championship? What about everything he's worked for?

**JORGE:** What about his life? You've seen the same impacts I have. You know what happens when the math goes wrong.

**ELENA:** I know. That's why I'm here. That's why I'm asking you to build a car that forgives mistakes. Not one that punishes them.

**JORGE:** Forgiving suspension geometry doesn't win championships. Just makes errors survivable.

**NARRATOR:** They both look at you. The question in their eyes is the same, but the answers they want are completely different.

**Choices:**

1. **"Jorge's right. A forgiving setup creates bad habits."**
   → Elena flinches, but doesn't argue. She's heard this before.
   ...
   _stats: driverTrust +5 · teamRespect +10_
2. **"Elena's right. Survival matters more than seconds."**
   → Jorge doesn't argue, but his hands tighten on the wrench he's holding.
   ...
   _stats: driverTrust +10 · mentalStress -10_
3. **"The question isn't the car. The question is whether he trusts the notes."**
   → Both of them look at you, surprised. This isn't the answer either of them expected.
   ...
   _stats: driverTrust +15 · teamRespect +10 · reputation +10 · mentalStress -5_

#### After the stage · scene 4 — COFFEE MACHINE · LATE NIGHT

**NARRATOR:** You're calling notes in your head, pacing the service park. Laurent appears beside you. He doesn't speak at first.

**LAURENT:** You're still doing it.
...
**YOU:** You told me that's when the road ends.
...
**LAURENT:** The one that doesn't end.
...
1. **(Continue your pacing)**
   → You keep calling notes in your head. The silence doesn't feel empty anymore. It feels like information.
   _stats: perception +5 · mentalStress -5_

#### After the stage · scene 5 — SERVICE PARK · MAIN WALKWAY

**NARRATOR:** The paddock is different now. People don't just see you—they see the person who kept Mikko competitive. The one who called the notes that shouldn't have worked but did.

**RANDOM_MECHANIC:** Hey—aren't you the one who called that triple-flat in Sweden? The one everyone said was impossible?
...
**YOU:** I just read the road. The rest was him.

**RANDOM_MECHANIC:** Sure. That's the humble answer.
...
1. **"Knowledge isn't factional. It's just knowledge."**
   → Mechanic: (laughs)
   ...
   _stats: reputation +10 · teamRespect +5_
2. **"What's the factory saying about me?"**
   → Mechanic: (glances at the factory motorhome)
   ...
   _stats: reputation +5_
3. **"Tell your team I'm always willing to share what I learn."**
   → Mechanic: (eyes widen)
   ...
   _stats: reputation +15 · teamRespect +10_

#### After the stage · scene 6 — SERVICE PARK · OUTSKIRTS

**NARRATOR:** The paddock feels colder. Not the temperature—the attitude. People move around you like you're not there, or worse, like you're a problem they're trying to avoid.

**SERVICE_WORKER:** Hey—move your equipment. You're blocking the fuel line.



He doesn't say it politely. He doesn't say it like he's talking to a peer. He says it like you're in the way.

**YOU:** We were here first. The fuel line can wait five minutes.

**SERVICE_WORKER:** Five minutes? That's cute.
...
1. **(Move the equipment without argument)**
   → You move the equipment. The service worker watches, disappointed that you didn't fight.
   ...
   _stats: reputation -5 · mentalStress +10_
2. **"What note did I supposedly call wrong?"**
   → Service Worker: (surprised you're engaging)
   ...
   _stats: reputation -5 · mentalStress +15_
3. **"I don't answer to you. I answer to my driver."**
   → Service Worker: (doesn't back down)
   ...
   _stats: reputation -10 · mentalStress +20_

### Chapter 2

#### Before the stage · scene 1 — TEAM TRUCK · ENGINEERING BAY

**SARA:** I've been watching your call data. Most guys in that seat just shout to be heard over the engine.

**YOU:** Volume isn't authority. Precision is.

**SARA:** (smiles)

Is that what you tell Mikko when he's mid-slide?

**YOU:** I don't tell him anything mid-slide. If he's sliding, I'm already three notes ahead, telling him how to get out of it.

**Choices:**

1. **"You engineer the car. I engineer his confidence."**
   → Sara: (nodding slowly)
   
   Confidence. That's what separates the good teams from the champions. He trusts you. That's rare in this sport.
   _stats: teamRespect +15 · driverTrust +5_
2. **"The car needs to match the notes, not the other way around."**
   → Sara: (laughs)
   
   You sound like the old Group B engineers. They'd say: 'Build the car, let the driver adapt.' Different world now.
   _stats: reputation +10 · teamRespect +5_

#### Before the stage · scene 2 — TEAM TRUCK · ENGINEERING BAY

**NARRATOR:** Sara has three laptops open and a setup sheet covered in her own shorthand. She doesn't look up when you walk in.

**SARA:** You put me on retainer instead of borrowing me from the factory team for one weekend at a time. That means I get to actually finish what I start.

**YOU:** Figured you'd earned a say in how this car gets built, not just patched between rallies.
...
1. **"Let's find out."**
   → Sara closes the laptops, one by one, like she's closing a case she's finally allowed to argue.
   _stats: teamRespect +10 · mentalStress -5_

#### After the stage · scene 1 — FINISH LINE · POST-STAGE

**NARRATOR:** The timing board shows your time. First place. But the reaction isn't just cheering—it's something else. Recognition.

**FIA_OFFICIAL:** That's... that's a new record for this stage.
...
**YOU:** We trusted the recce. We trusted each other.
...
1. **"It's not trust. It's preparation."**
   → FIA Official: (smiles)
   ...
   _stats: reputation +10 · teamRespect +5_
2. **"Trust is easy when you have the right data."**
   → FIA Official: (interested)
   ...
   _stats: reputation +15_
3. **"What happens when we stop trusting each other?"**
   → FIA Official: (doesn't hesitate)
...
#### After the stage · scene 2 — FINISH LINE · POST-STAGE

**NARRATOR:** The timing board shows your time. Last place. The silence is worse than the booing would be.

**TEAM_MANAGER:** We need to talk about the notes.
...
1. **"The notes were right. He didn't trust them."**
   → Team Manager: (doesn't blink)
   ...
   _stats: driverTrust -10 · reputation -5 · mentalStress +15_
2. **"I hesitated. The conditions were worse than we expected."**
   → Team Manager: (nods)
   ...
   _stats: reputation +5 · mentalStress +5_
3. **"We both made mistakes. That's racing."**
   → Team Manager: (considers this)
...
#### After the stage · scene 3 — SERVICE PARK · FAMILY AREA

**NARRATOR:** A young girl is sitting on a tire stack, watching the mechanics work. She's maybe eight years old, wearing a team shirt that's three sizes too big.

**GIRL:** My dad says you're the one who keeps the car on the road.
...
**YOU:** I just read the road. Your dad does the hard part.

**GIRL:** He's been a mechanic for twenty years. He says he's never seen a driver trust someone the way Mikko trusts you.
...
1. **"Anyone can learn to read notes. It takes courage to trust them."**
   → The girl considers this, like it's the first time anyone's given her a real answer.
   ...
   _stats: reputation +5_
2. **"This isn't an easy job. The pressure is intense."**
   → Girl: (nods)
   ...
   _stats: reputation +5_
3. **"What does your dad think about you being a co-driver?"**
   → Girl: (surprised)
...
#### After the stage · scene 4 — ABANDONED SERVICE BAY

**NARRATOR:** You're cutting through an abandoned service bay when you see it—a photograph nailed to a beam, faded but preserved. It shows a rally car from another era, stopped at the side of a road.

**NARRATOR:** Two people stand next to it. A driver with a confident smile. A co-driver who looks terrified but determined.

**VOICE:** Found you, didn't I?
...
**OLD_MECHANIC:** They won. Set a record that still stands.
...
1. **"What was she like?"**
   ...
   _stats: reputation +5_
2. **"Why keep the photo here?"**
   → Old Mechanic: This is where they worked. This bay.
   ...
   _stats: reputation +5_
3. **"Group B was dangerous. The ban was necessary."**
   → Old Mechanic: (doesn't argue)
...
#### Before the stage · scene 1 — FIA MEETING ROOM · LATE NIGHT

**NARRATOR:** The FIA steward doesn't look like a bureaucrat. He looks like someone who's seen too many accidents and has decided the solution is more paperwork.

**STEWARD:** We have a proposal. New safety regulations for Group B.
...
**STEWARD:** The manufacturers. They want to sell fast cars to the public. Safety hurts marketing.
...
**STEWARD:** The certification process is expensive. Factory teams can afford it. Privateers can't.
...
1. **"This just kills privateer competition under the guise of safety."**
   → Steward: (doesn't argue)
   ...
   _stats: reputation +10_
2. **"I'll speak for the privateers. But I want something in return."**
   → Steward: (raises eyebrow)
   ...
   _stats: reputation +15_
3. **"Safety shouldn't be a luxury item. Either it's mandatory or it's not."**
   → Steward: (genuinely impressed)
...
#### Before the stage · scene 2 — SUPPLIER WAREHOUSE

**NARRATOR:** The parts supplier is doing something unusual—he's allocating inventory. When a sport runs on limited parts, allocation becomes power.

**SUPPLIER:** Factory team put in a massive order. They want to lock down the entire supply of differentials for the season.
...
**SUPPLIER:** Inside information. When the FIA makes its ruling on the safety certification, I need to know first. I can adjust my inventory accordingly.
...
1. **"I won't betray the FIA process for parts allocation."**
   → Supplier: (nods, not in anger but in respect)
   ...
   _stats: reputation +10_
2. **"I'll get you the information. But the privateers get guaranteed allocation."**
   → Supplier: (extends hand)
   ...
   _stats: reputation +5_
3. **"What if I convince the FIA to block the exclusivity deal entirely?"**
   → Supplier: (genuinely surprised)
...
#### Before the stage · scene 1 — THE FINAL SERVICE · 03:00

**NARRATOR:** Mikko is sitting in the dark. No flask this time. Just a glass of water and a thousand-yard stare. The Girlfriend is standing over him, not whispering—just being there. She stops when you approach, not because you interrupted, but because she's been waiting for you.

**GIRLFRIEND:** I've been running the numbers for three years. Every stage, every corner, every note.
...
**MIKKO:** What do the notes say?

**YOU:** The notes say there's a championship at the end of the next thirty kilometres.

**MIKKO:** That's not what the notes say.
...
1. **"Then let's go find out what's coming."**
   → Mikko: (nods)
   ...
   _stats: driverTrust +20 · reputation +15 · legacy +25 · mentalStress -5_
2. **"The notes say what's coming. We're what decides whether we survive it."**
   → Mikko: (stops at the car door, turns)
   ...
   _stats: driverTrust +15 · reputation +10 · legacy +20_
3. **"Some roads don't have an end you can see. We drive them anyway."**
   → Mikko: (laughs, softly)
   ...
   _stats: driverTrust +10 · reputation +20 · legacy +30 · mentalStress -15_

## Route: FEMALE CO-DRIVER

### Intro

You don't just call the notes. You translate fear into focus.
...
#### Before the stage · scene 1 — SERVICE PARK · THE TRAILER

**NARRATOR:** The team manager looks at his clipboard, then at you. He's already made up his mind about you. He just hasn't said it yet.

**MANAGER:** The driver's nervous. First female co-driver he's had. Hell, first female co-driver anyone's had in Group B. You ready for this?

**YOU:** I've been ready for years. The question is: is he ready for me?

**Choices:**

1. **"I didn't come here to be a novelty. I came here to win."**
   ...
   _stats: grit +20 · reputation +10 · driverTrust +5_
2. **"Just watch the times. That's all that matters."**
   → Manager: (grunts)
   ...
   _stats: grit +15 · teamRespect +10 · reputation +5_
3. **"Tell him to focus on the road, not my gender."**
   → Manager: (stiffens)
   
   Careful. You're already walking on thin ice. But... (half-smile) I like the fire. Just aim it at the competition.
   _stats: grit +25 · reputation +15 · mentalStress +10_

#### Before the stage · scene 2 — THE COCKPIT · 04:30

**NARRATOR:** He's young. Too young for Group B, some say. But he has the eyes—hungry, scared, desperate to prove himself.

**DRIVER:** Sofia, right? Look... I'm not gonna lie. I asked for a guy. Someone who could... you know... handle the pressure.

**YOU:** Handle the pressure? Or handle your ego?

**Choices:**

1. **"I've handled worse than you. Let's drive."**
   → He blinks. Then laughs—nervous, surprised.
   
   
   
   Driver: Jesus. Okay. Okay, let's see what you've got.
   _stats: grit +15 · driverTrust +10 · reputation +5_
2. **"Close your eyes. Listen to my voice. That's all that matters."**
   → He stares at you. Then slowly nods.
   
   
   
   Driver: Yeah. Okay. Just... don't let me die out there.
   _stats: driverTrust +15 · mentalStress -5_
3. **"You asked for a guy. You got the best co-driver on the grid. Deal with it."**
   → Silence. Then he extends his hand.
   
   
   
   Driver: I'm Marcus. Let's go shock the world.
   _stats: grit +20 · reputation +10 · driverTrust +5 · mentalStress +5_

#### After the stage · scene 1 — SERVICE PARK

**NARRATOR:** The mechanics work in silence. Marcus is trembling—adrenaline or fear, you can't tell.

**DRIVER:** I've never... I mean... those speeds. The notes came so fast. You were like... like you weren't even breathing.

**YOU:** I wasn't. Neither were you. That's the point.

**Choices:**

1. **"You trusted me. That's the hardest part done."**
   → Marcus looks at you differently now. Less doubt. More... something else.
   
   
   
   Driver: I did. I actually did. Let's do it again.
   _stats: driverTrust +20 · grit +10 · mentalStress -10_
2. **"Next time, trust the notes, not your fear."**
   → He nods, chastened but hungry.
   
   
   
   Driver: Teach me. I want to learn.
   _stats: driverTrust +15 · teamRespect +5 · grit +5_

### Chapter 2

#### Before the stage · scene 1 — PRESS PEN

**NARRATOR:** She's been in the sport longer. She's earned her seat. And she sees you as a threat to everything she's built.

**CLAIRE:** So you're the experiment. The token. Tell me—how does it feel knowing every mistake you make closes the door for the rest of us?

**YOU:** Every mistake I don't make kicks that door wide open.

**Choices:**

1. **"I'm not a token. I'm a weapon."**
   → Claire studies you. No smile. Just assessment.
   
   
   
   Claire: Good answer. Now prove it.
   _stats: grit +20 · reputation +15 · mentalStress +10_
2. **"I'm carrying the weight for all of us. I won't drop it."**
   → Claire's expression softens—barely.
   
   
   
   Claire: That's the first honest thing you've said. Carry it well.
   _stats: grit +15 · reputation +10 · teamRespect +5_
3. **"Watch the times. Then tell me if I'm an experiment."**
   → Claire laughs—genuine, surprised.
   
   
   
   Claire: Oh, I like you. I actually like you. That's dangerous.
   _stats: reputation +20 · grit +10_

### Chapter 3

#### Before the stage · scene 1 — TEAM HOTEL · BAR

**NARRATOR:** You shouldn't be here. He shouldn't be here. But the rally is a pressure cooker, and something's about to blow.

**MARCUS:** My girlfriend thinks I'm sleeping with you. She says the way you look at me in the car... it's intimate.

**YOU:** The way I look at you? I'm reading the road ahead. That's not intimate, that's survival.

**MARCUS:** She wants me to request a different co-driver. Says you're... distracting.

**Choices:**

1. **"I'm not your problem. Your girlfriend's insecurity is."**
   → Marcus flinches. Then nods slowly.
   ...
   _stats: driverTrust +15 · mentalStress +10 · grit +5_
2. **"Tell her the car is too small for drama. Keep it out of the cockpit."**
   → Marcus: (half-smile)
   
   Too small for drama. I like that. I'll use that.
   _stats: driverTrust +10 · reputation +5_
3. **"If she's threatened by me, what happens when we win?"**
   → Marcus looks at you—really looks at you.
   
   
   
   Marcus: Then I guess we'll find out what she's really made of.
   _stats: grit +20 · mentalStress +15 · reputation +10_

#### Before the stage · scene 2 — FIA INVESTIGATION ROOM

**STEWARD:** We've received a formal complaint. Technical discrepancy in your notes—per regulation 14-B, section 3. Espionage implications.

**YOU:** That's ridiculous. I write my own notes. Every syllable is mine.

**STEWARD:** Complaint originates from a registered competitor. They seek immediate suspension pending formal investigation—per protest protocols.
...
1. **"Marcus, don't. I can handle this."**
   → Marcus: (fierce)
   ...
   _stats: driverTrust +25 · reputation +10 · grit +15_
2. **"Check my notebooks. Every page is dated. Every note is documented."**
   → You produce your notebooks—meticulous, obsessive, dated. The steward's case crumbles.
   
   
   
   Steward: This... this is thorough. The complaint is dismissed.
   _stats: reputation +20 · teamRespect +15_
3. **"Who filed the complaint? Let me guess—Claire Rennick?"**
   → The steward's silence confirms it. Marcus curses.
   
   
   
   Marcus: She's scared of you. Good. Let her be scared.
   _stats: grit +20 · mentalStress +10 · reputation +15_

#### After the stage · scene 1 — PRESS CONFERENCE

**NARRATOR:** The questions aren't about racing. They're about what you represent. The microphone feels like a weapon pointed at you.

**REPORTER:** There's a movement in the FIA to address gender disparities in motorsport. Some are saying your presence this season is proof that the system works.
...
1. **"I'm here because I earned it. Not because of anyone's agenda."**
   → Reporter: (doesn't flinch)
   ...
   _stats: reputation +10 · grit +15_
2. **"The system doesn't work. That's why I had to be twice as good to get half the respect."**
   → Reporter: (nods, genuinely interested)
   ...
   _stats: reputation +15 · grit +20_
3. **"I'm not a symbol. I'm a co-driver. Ask me about the notes, not the politics."**
   → Reporter: (frustrated)
...
#### After the stage · scene 2 — SERVICE PARK · NIGHT

**NARRATOR:** The paddock is buzzing with rumors. The FIA meeting is tomorrow, and everyone knows something big is being decided.

**PRIVATEER_REPRESENTATIVE:** Heard you're speaking for us at the FIA meeting.
...
1. **"A separate series is a death sentence. No sponsors, no coverage, no future."**
   → Privateer Rep: (doesn't argue)
   ...
   _stats: reputation +5_
2. **"I'm fighting for your survival. Whether you appreciate it or not."**
   → Privateer Rep: (laughs, bitter)
   ...
   _stats: reputation +5 · mentalStress +10_
3. **"Then let's create a third option. A privateer series with FIA backing."**
   → Privateer Rep: (stops, genuinely surprised)
   ...
   _stats: reputation +20_

### Chapter 4

#### Before the stage · scene 1 — THE FINAL SERVICE · 04:00

**NARRATOR:** This is it. One stage. One championship. Everything you've fought for. Everything they said you couldn't have.

**CLAIRE:** (appearing from the shadows)

You made it further than I thought. But this stage? This is where experiments end.

**YOU:** Or where legends begin.

**MARCUS:** (to both of you)

I'm not a passenger in this story. I'm the driver. And I choose who sits next to me. I choose her.

**CLAIRE:** Then when you crash, remember—I offered you wisdom. You chose... novelty.

**Choices:**

1. **"Get out of our garage. We have a championship to win."**
   → Claire leaves. Marcus grips your shoulder.
   
   
   
   Marcus: Let's go make history. Together.
   _stats: grit +30 · driverTrust +20 · legacy +30 · mentalStress -20_
2. **"Marcus, look at me. Eyes on my voice. Nothing else exists."**
   → He centers. Breathes. Becomes the driver he was meant to be.
   
   
   
   Marcus: I'm ready. Call the notes. I'll follow you anywhere.
   _stats: driverTrust +25 · legacy +25 · grit +20_
3. **"Claire, watch the stage. Watch me prove you wrong."**
   → Claire's mask cracks—just for a second. Envy? Respect?
   
   
   
   Claire: I'll be watching. Don't disappoint me.
   _stats: reputation +25 · grit +25 · legacy +20_

#### After the stage · scene 1 — FINISH LINE

**NARRATOR:** The timing beam. The silence. Then the world explodes—or it doesn't.

**Choices:**

1. **(If Won) Accept the trophy**
   → Champagne. Cameras. Marcus lifts you onto the car—a co-driver's place, but elevated. Visible.
   ...
   _stats: legacy +50 · reputation +30 · grit +20_
2. **(If Lost) Face the press**
   → The questions are cruel. But you stand there. Take them.
   ...
   _stats: grit +30 · legacy +10 · mentalStress +10_

---

# MIDNIGHT CLASS — Street / Wangan

*Theme: Street (neon Yokohama)*

**Cast:** You (homeless kid turned navigator) · Kenji Okabe (71, tuner) · Haruto Sato (22, driver) · Mori Ryosuke (sponsor)

## Route: MALE CO-DRIVER

### Intro — YOKOHAMA · DAIKOKU PA · 02:40

The Wangan doesn't care where you slept last night.
...
#### Before the stage · scene 1 — OKABE GARAGE · BACK OF THE YARD · 23:10

**NARRATOR:** The garage smells like machine oil and old cigarettes. Kenji Okabe is seventy-one years old and his hands shake until they touch an engine. He kicks a crate out from under the workbench. It is the closest thing to a welcome he offers.

**KENJI:** You slept in the red coupe out back. Four weeks. I let it slide because a man who is quiet is not necessarily stupid. Last night I heard you reading the road to yourself through the wall. You have never sat in a race car. Explain yourself.

**YOU:** I called every corner of the Bayshore loop against the radio feed. Called the camera vans too. Got three out of four wrong. But the fourth was the Yokohane split, and the broadcast got it wrong and I got it right.

**KENJI:** Hm. The split kills better drivers than the radio. Listen. My driver is Haruto — twenty-two, faster than sense, sponsored by people who want him loud and disposable. His last co-driver quit on the starting line. You will sit next to him. You will keep him alive. In exchange: the flat above the shop and two meals a day. Do not make me regret charity.

**Choices:**

1. **"You heard one night. Why spend a seat on a stranger?"**
   → Kenji: (lights a cigarette with hands that barely shake)
   ...
   _stats: driverTrust +10 · teamRespect +10 · mentalStress -5_
2. **"Deal. But I say what gets called. His car, my voice."**
   → Kenji: (laughs, a real one, then coughs it away)
   ...
   _stats: driverTrust +5 · teamRespect +15 · mentalStress +5_
3. **"I owe you nothing. This is a job, not a debt."**
   → Kenji: (smoke curls toward the exhaust fan)
   ...
   _stats: teamRespect +10 · grit +10_

#### Before the stage · scene 2 — DAIKOKU PA · UNDER THE LIGHTS · 01:55

**NARRATOR:** Haruto Sato leans against the Supra like the car belongs to him and he belongs to the city. Both are true. He does not look at you when he talks. He looks at the tunnel.

**HARUTO:** Kenji says you read the road like you invented it. Cool. But let me be clear about what you are. You are a seat-warmer with a good mouth. When I say push, the call is push. When I feel a line, the line is mine. Keep up or keep quiet.

**Choices:**

1. **"When you are sideways at 280, my mouth is the only thing between you and the guardrail."**
   → Haruto: (finally looks at you — a quick, hungry read)
   ...
   _stats: driverTrust +15 · mentalStress +5_
2. **"You take a line against my call, I stop reading. Both of us eat the wall or neither."**
   → Haruto: (grins, sharp)
   ...
   _stats: driverTrust +10 · teamRespect +5 · mentalStress +10_

#### After the stage · scene 1 — OKABE GARAGE · 04:20

**NARRATOR:** The Supra cools in the yard, ticking like a clock. Kenji is under it with a flashlight in his teeth. He speaks to the undercarriage instead of to you.

**KENJI:** Brake dust pattern says he took the tunnel gap two clicks faster than your call. Says here you kept reading. Kept reading while the car did something the call did not say. That is either loyalty or stupidity, and from this angle they look identical.

**YOU:** It was both. It is always going to be both with him, isn't it.

**KENJI:** It was always both with everyone I ever built for. Go to sleep. Same time tomorrow. And kid — the flat above the shop. It is yours. It has a lock. First door in four weeks that locks from the inside. Try not to look so surprised about it.

**Choices:**

1. **Say thank you.**
   → Kenji: (does not look up from the brakes)
   ...
   _stats: driverTrust +5 · teamRespect +5 · mentalStress -10_
2. **Pick up a wrench and start on the other side.**
   → Kenji: (pause. The flashlight beam steadies on your hands)
   ...
   _stats: teamRespect +15 · grit +5_

#### After the stage · scene 2 — OKABE GARAGE · POLICE SCANNER STILL WARM · 03:15

**NARRATOR:** Two scanner calls tonight, both with the word "Daikoku" in them. Haruto is filming his shoes for his feed. Kenji has not said a word since midnight, which by his standards is a screaming match.

**KENJI:** The club I built had one rule that mattered: you never made the police a show. Speed on the empty road, respect the public, and the city looked away. These new crews film everything. Eat everything. And now there is a task force with a list, and the list has my old crest on it.

**Choices:**

1. **"Then we run quieter. Fewer runs, cleaner runs, no cameras."**
   → Kenji: (nods slowly, once)
   ...
   _stats: teamRespect +10 · mentalStress -5_
2. **"Or we get loud once, big, and buy our way out of the spotlight with one perfect run."**
   → Haruto: (head snaps up from the phone)
...
#### Before the stage · scene 1 — MINATO MIRAI · SPONSOR SUITE · 22:00

**NARRATOR:** The sponsor suite smells like money that has never been cold. A man in a jacket worth your whole building slides a folder across the table. The folder has Haruto's times in it and Kenji's old crest on it and your name in a field labeled ASSETS.

**MORI:** Mori Ryosuke, Aegis Racing Development. We are buying three Wangan teams and merging them into one program. Real money. Real cars. The old man's engines, my budget, your boy's face. All we ask is the loud stuff. All of it. Feeds, stunts, police bait. Fear is content, kid.

**KENJI:** And I ask the opposite. Quiet roads, clean runs, the way the club survived thirty years. Choose, co-driver. Whatever you choose, Haruto will follow. He follows you now. He has not told you that, so I am telling you.

**Choices:**

1. **"We stay clean. Haruto is a driver, not content."**
   → Mori: (closes the folder, smiles like a toll gate)
   ...
   _stats: teamRespect +15 · grit +10 · driverTrust +10_
2. **"Show me the money. All of it. Then I decide what it costs."**
   → Mori: (slides a number across the table that could rebuild a neighborhood)
   ...
   _stats: reputation +15 · teamRespect -10 · mentalStress +10_

#### Before the stage · scene 2 — OKABE GARAGE · AMBULANCE LIGHTS FADING · 05:05

**NARRATOR:** It happened at the workbench, mid-valve-adjustment. The paramedics called it a warning, not an ending. Kenji is arguing with them in a voice like torn paper. He signs his own discharge risk form with a wrench-steady hand that shook all morning holding coffee.

**KENJI:** Sit down. You look like a witness. I am fine. The heart is seventy-one years old, like the rest of me, and it is entitled to complain. What matters: the balancing on car three is wrong, the Shimamoto tune runs rich in the rain, and you are the only one in this shop Haruto cannot lie to. So you will carry more. Starting tonight.

**YOU:** You should not be alone in this shop. And you should not be tuning engines six hours after your heart files a complaint.

**KENJI:** And you should not have been sleeping in a coupe, and here we both are. The shop does not close because flesh is temporary. Now — do you tell Haruto what happened, or do we let him drive fast on a peaceful heart? Choose. He reads people faster than roads.

**Choices:**

1. **"Haruto knows. He deserves the weight of it."**
   → Haruto: (very quiet, for him)
   ...
   _stats: driverTrust +15 · teamRespect +10_
2. **"He never knows. The team stays light."**
   → Kenji: (grim approval)
   ...
   _stats: grit +15 · mentalStress +15_

#### After the stage · scene 1 — TUNNEL EXIT · DAWN · 05:40

**NARRATOR:** Aegis Racing's GTR is parked across the tunnel mouth like a cheque nobody will cash. Mori steps out in driving shoes that have never seen gravel.

**MORI:** Nice run. Clean. Quiet. Boring as a tax form — which is my whole problem with it. Haruto, baby, my offer now includes a spot in the World Time Attack shoot-out. Cameras on ten million screens. All you have to do is stop letting the paperboy steer.

**HARUTO:** (long pause — you watch his jaw work)
...
1. **Say nothing. Let Haruto have the moment.**
   → Mori: (gets back into the GTR)
   ...
   _stats: driverTrust +20 · teamRespect +10 · mentalStress -10_
2. **"He counts your wall saves. That is the whole pitch, Mori. Now move your car."**
   → Mori: (wheels turning, recalculating)
   ...
   _stats: driverTrust +10 · teamRespect +15 · reputation +10_

#### After the stage · scene 2 — OKABE GARAGE · CHECKPOINTS ON THE SCANNER · 23:50

**NARRATOR:** They have started impounding at the on-ramps. Not chasing — waiting. The task force learned what Kenji's generation knew: you do not catch a Wangan car by driving. You catch it by making the city smaller.

**KENJI:** Shimamoto's crew was taken at the Yokohane ramp tonight. Cars in the impound, names in the paper. His lead tuner is eighteen. Eighteen, and he is looking at the same list my crest is on. One more run on those roads and the shop is finished — not from a crash. From paperwork.

**Choices:**

1. **"One last run. The loop, at dawn, empty. Then we go quiet for good."**
   → Kenji: (long exhale — smoke, then something older than smoke)
   ...
   _stats: driverTrust +15 · grit +10 · mentalStress +5_
2. **"We stop tonight. The runs end before the list ends us."**
   → Haruto: (slams a toolbox — then, worse, goes quiet)
   ...
   _stats: teamRespect +10 · mentalStress -15 · driverTrust -10_

### Chapter 3

#### Before the stage · scene 1 — OKABE GARAGE · RAINY TUESDAY · 19:40

**NARRATOR:** Between the big nights there are the small ones. Mori Ryosuke’s people left a contract on the bench — “Team Aegis” in expensive print, a number with two commas, and a clause that hands them the crest if you ever finish off the podium twice in a row. Kenji has not touched it. He has instead rebuilt the red coupe’s carburetor for the fourth time this month, for a car that will never run, while his pills sit unopened on the windowsill.

**KENJI:** Sign it or burn it, but decide by Friday. And before you ask — yes, I met Mori in 1991. He shook my hand with a stopwatch in his pocket and timed how long I would talk. That is the whole man. Everything is a lap to people like that. Do not let him lap YOU.

**Choices:**

1. **“We decline. The shop does not sell its name.”**
   → Kenji: (slides the contract into the parts drawer marked SCRAP)
   ...
   _stats: teamRespect +15 · legacy +10 · mentalStress +5_
2. **“We sign — but the crest stays ours, on paper, in ink.”**
   → Kenji: (reads the amendment twice, then laughs until he coughs)
   ...
   _stats: reputation +20 · mentalStress +15_

#### After the stage · scene 1 — YOKOHAMA · GARAGE FRIDGE · 01:12

**NARRATOR:** The next crackdown list comes down like weather. Shimamoto’s crew got swept Monday; their Supra sits in the city pound between a stolen scooter and a hearse. Haruto tapes the news clipping to the garage fridge and says nothing all night, which from Haruto is a shout.

**HARUTO:** They clocked a Skyline doing 289 on the Yokohane. 289. The thread is calling him the last king and calling US the last kings’ cousins, which feels less cool from inside the cousin seat. Kenji says the fast ones never get caught — only the visible ones. So the question is: how visible do we want the last few runs to be?

**Choices:**

1. **“Quiet ones. Unlisted roads. We finish the season invisible.”**
   → Haruto: (takes the clipping off the fridge and folds it into his wallet)
   ...
   _stats: grit +10 · reputation -5 · mentalStress -10_
2. **“Loud ones. If the scene ends, it ends on OUR name, not the police log.”**
   → Haruto: (grins like the first night you met him)
   ...
   _stats: reputation +15 · driverTrust +10 · mentalStress +10_

### Chapter 4

#### Before the stage · scene 1 — THE WANGAN · DAWN · 04:59

**NARRATOR:** The city gives you forty minutes of mercy before the traffic wakes. The Supra idles at the ramp like a held breath. Kenji is here — he should not be, his doctor definitely has opinions, and he stands there anyway with the stopwatch he has carried since 1987.

**KENJI:** Boys. The club had a saying for this. Not "go fast." We said: COME HOME. Every run, every night, thirty years. Come home. That is the whole religion. Call it clean, drive it whole, and come home.

**HARUTO:** (quiet, checking the map one last time)
...
1. **"Call it like I always do. You come home to me. That is the deal."**
   → Haruto: (bumps your fist against the roll cage)
   ...
   _stats: driverTrust +25 · mentalStress -10 · legacy +10_
2. **"Tell your kid the truth: we were never legends. We were careful. That is why we lived."**
   → Kenji: (closes his eyes, the stopwatch still)
   ...
   _stats: teamRespect +20 · legacy +15 · grit +10_

#### After the stage · scene 1 — OKABE GARAGE · ONE YEAR LATER

**NARRATOR:** The list got Shimamoto's crew and two others. It never got yours. The shop still stands: half of it legal classics now, Kenji's crest on the wall in a frame the fire marshal made him buy. The red coupe out back still does not run. Kenji refuses to fix it. You know better than to ask why.

**KENJI:** Sit. The new kids in the back bay are slow and polite and they think a boost gauge is technology. I let them believe it. Meanwhile: Haruto passed his insurance exams. Sends me a postcard every quarter, signs it "the last co-driver." I framed the first one and denied crying about it.

**KENJI:** You. The sign above the bench says OKABE &amp; CO. It should say OKABE &amp; SON. Not blood. Better than blood. If you want it, it is yours. The shop, the crest, the whole stubborn thing. Choose fast, my heart is old, and I hate saying sentimental things twice.

**Choices:**

1. **Take the crest. Keep the shop alive.**
   → Kenji: (hands over the stopwatch too — 1987 to now, no ceremonies)
   ...
   _stats: legacy +30 · teamRespect +20 · grit +10_
2. **Refuse kindly. The shop should end with its maker.**
   → Kenji: (a long, real laugh — then a cough, then a nod)
   ...
   _stats: legacy +25 · mentalStress +10 · grit +15_

## Route: FEMALE CO-DRIVER

### Intro — YOKOHAMA · DAIKOKU PA · 02:40

The Wangan doesn't care where you slept last night — and it
...
**NARRATOR:** The garage smells like machine oil and old cigarettes. Kenji Okabe is seventy-one, and his hands shake until they touch an engine. He looks at you longer than is comfortable. Not because you slept in his spare coupe. Because he is doing arithmetic about the world and does not like the answer.

**KENJI:** Four weeks in my coupe and never once asked for anything. Last night I heard you reading the Bayshore to yourself through the wall — every corner, every camera van. When Haruto's people post the seat opening, they will tell you a girl in the passenger seat is a marketing problem. I have outlived caring what people post. Sit. Talk.

**YOU:** I called the Yokohane split against the broadcast and got it right when they got it wrong. That is the whole pitch. That is everything I have.

**KENJI:** The split. Hm. My old club's rule was simpler than gender: can you read the road, and will you come home. Everything else is decoration. Haruto is my problem — twenty-two, sponsored, faster than sense. His last co-driver quit. The seat is yours if you want a door that locks from the inside.

**Choices:**

1. **"I want the seat. Not the charity. I earn every run."**
   → Kenji: (the first thing resembling a smile)
   ...
   _stats: grit +15 · teamRespect +10_
2. **"And if Haruto has a problem with a girl reading his race?"**
   → Kenji: (smoke, and a long look)
   ...
   _stats: driverTrust +10 · grit +10_

#### Before the stage · scene 2 — DAIKOKU PA · UNDER THE LIGHTS · 01:55

**NARRATOR:** Haruto Sato leans against the Supra, filming a shoe-angle shot for his feed. He clocks you, does a double take at the helmet under your arm, and his face does something complicated.

**HARUTO:** Kenji said... okay, Kenji said a lot of words. Bottom line: you are my new reader. Look, no offense, but my sponsor edits around optics. A girl calling my race is going to be the whole comment section. Can your voice carry over that or do I get a migraine every run?

**Choices:**

1. **"I carried over a radio broadcast through a concrete wall. Your ego will be fine."**
   → Haruto: (caught between a laugh and a blush)
   ...
   _stats: driverTrust +15 · grit +5_
2. **"Your sponsor edits optics. I edit survival. I outrank him."**
   → Haruto: (blink. Recalculation. A slow grin)
   ...
   _stats: driverTrust +10 · teamRespect +15 · grit +10_

#### After the stage · scene 1 — OKABE GARAGE · PHONES FACE-DOWN · 04:30

**NARRATOR:** Somebody filmed the dawn run from the overpass. The clip has nine hundred thousand views and a comment section that has discovered, in real time, what a girl sounds like at 290. Haruto keeps opening his phone. Kenji keeps closing it for him.

**KENJI:** In my club there was a woman named Reina who read the Wangan better than anyone alive. Nobody filmed her. This city ate quietly then. Now it eats loudly. The question is not the noise, girl. The question is whether the noise reaches the driver's helmet while the road is happening. Haruto. Does it?

**HARUTO:** (long pause, honest)
...
1. **"Then the noise is your problem to mute and mine to outdrive."**
   → Kenji: (to the workbench, to nobody) Note it down. First run, first noise storm, and she made it into weather. Just weather.
   ...
   _stats: driverTrust +20 · grit +10 · mentalStress -10_
2. **"Nine hundred thousand people just heard the calls hold. That is not noise. That is a resume."**
   → Haruto: (stares at the view counter, then at you)
   ...
   _stats: reputation +15 · driverTrust +10 · grit +10_

#### After the stage · scene 2 — OKABE GARAGE · POLICE SCANNER STILL WARM · 03:15

**NARRATOR:** Two scanner calls tonight, both with "Daikoku" in them. The task force has a list, and Kenji's old crest is on it. Haruto is filming his shoes again. Kenji has not spoken since midnight, which by his standards is a scream.

**KENJI:** My club survived thirty years on one rule: never make the police a show. These crews film everything, eat everything, and now there is a list. I am too old to run and the shop is too legal to burn. Choose our road, girl. Haruto follows you now. He has not noticed. I am telling you so you can carry it gently.

**Choices:**

1. **"We run like ghosts — fewer runs, cleaner runs, zero cameras."**
   → Kenji: (one slow nod, the highest honor he issues)
   ...
   _stats: teamRespect +15 · grit +10 · mentalStress -5_
2. **"One perfect run, huge, then silence. We spend the noise we already made."**
   → Kenji: (grim arithmetic on his face)
   ...
   _stats: driverTrust +10 · teamRespect -5 · mentalStress +10 · reputation +10_

### Chapter 2

#### Before the stage · scene 1 — MINATO MIRAI · SPONSOR SUITE · 22:00

**NARRATOR:** Aegis Racing Development has a folder with your name in it. In the field where a person would be listed, it says ASSETS, and someone has underlined it twice. Mori Ryosuke smiles like a toll gate.

**MORI:** A girl who out-called a broadcast through a wall — do you know what you are worth as a STORY? Nine hundred thousand people already know. Sign with Aegis and we triple it. The feeds, the stunts, the drama. Fear is content, and you read fear better than anyone I have ever seen.

**KENJI:** (from the doorway, uninvited, immovable)
...
1. **"I am not your asset. I am not Kenji's either. I am the voice, and the voice is mine."**
   → Mori: (closes the folder, delightfully disgusted)
   ...
   _stats: grit +20 · teamRespect +15_
2. **"Triple it and put it in writing — then watch me spend it my way."**
   → Mori: (actually surprised, then delighted)
   ...
   _stats: reputation +20 · mentalStress +10 · teamRespect -5_

#### Before the stage · scene 2 — OKABE GARAGE · AMBULANCE LIGHTS FADING · 05:05

**NARRATOR:** It happened at the workbench, mid-valve-adjustment. The paramedics called it a warning, not an ending. Kenji signs his own discharge-risk form with a wrench-steady hand that shook all morning holding coffee. Haruto does not know yet. He is asleep on the cot, helmet still on.

**KENJI:** Sit. The heart is seventy-one and entitled to complain. What matters: car three's balance is wrong, the Shimamoto tune runs rich in the rain, and you are the only one in this shop Haruto cannot lie to. You will carry more now. And girl — do not let them turn you into a nurse with a headset. You are a reader. The best I have heard in thirty years. Both things are true at once. Carrying weight does not mean shrinking.

**Choices:**

1. **"Haruto knows. Tonight. He deserves the weight."**
   → Haruto: (waking badly, hearing it all, very quiet)
   ...
   _stats: driverTrust +15 · teamRespect +10_
2. **"He never knows. I carry it. The team stays light."**
   → Kenji: (grim approval, softer than usual)
   ...
   _stats: grit +15 · mentalStress +20_

#### After the stage · scene 1 — TUNNEL EXIT · DAWN · 05:40

**NARRATOR:** Aegis's GTR sits across the tunnel mouth. Mori steps out in driving shoes that have never met gravel, phone already broadcasting.

**MORI:** There she is — the Voice of the Wangan. Nine-fifty now, the view count. Sign, and I put that voice in ten million earbuds. Haruto, you can come too, the channel loves a handsome hood ornament. — Haruto's hand finds the Supra's door handle. Whatever he is about to do, he is about to do it fast.

**HARUTO:** Delete "hood ornament" from your vocabulary and your talent roster. She kept me off the wall three times tonight. I counted. Ask your telemetries guy how many wall saves Aegis buys. We're out, Mori. — To the phone, directly: And to the comments: she calls it, I drive it, and we both come home. That is the whole sport. Unfollow if you hate it.

**Choices:**

1. **Let the clip run. He is saying it better than you ever could.**
   → The clip hits two million by noon. The comment section does not forgive — but it redirects. Ten thousand new followers whose first word from you was a wall save.
   ...
   _stats: reputation +20 · driverTrust +15 · grit +10_
2. **"Ten million earbuds, Mori? Start with one: mine. We say no on our own channel."**
   → You film the refusal on the Supra's hood, at the tunnel mouth, with the dawn coming up behind you. It is not content. It is a statement of account: who kept whom alive, what the noise never touches.
   ...
   _stats: legacy +15 · teamRespect +15 · reputation +10_

#### After the stage · scene 2 — OKABE GARAGE · CHECKPOINTS ON THE SCANNER · 23:50

**NARRATOR:** They impound at the on-ramps now. Not chasing — waiting. Shimamoto's crew was taken at the Yokohane ramp, cars and all. His lead tuner is eighteen. The city is getting smaller by the week.

**KENJI:** One more list night and the shop is finished — not by a crash. By paperwork. I have thirty years of receipts and a heart that complains. You two have futures that fit in envelopes. Choose our road, both of you. I will drive whatever you decide, even parked in the yard with the engine off. Even that, I would drive.

**Choices:**

1. **"The last run: dawn, empty loop, gentle sheet. Then we ghost for good."**
   → Kenji: (eyes closed, the whole religion in one exhale)
   ...
   _stats: driverTrust +15 · legacy +10 · grit +10_
2. **"We end it tonight. The runs stop before the names go on lists."**
   → Haruto: (slams the toolbox — then goes quiet, which is worse)
   ...
   _stats: teamRespect +10 · mentalStress -15 · driverTrust -10 · legacy +5_
...
**KENJI:** Sign it or burn it, but decide by Friday. And before you ask — yes, I met Mori in 1991. He shook my hand with a stopwatch in his pocket and timed how long I would talk. That is the whole man. Whatever he offers the girl who slept in my yard, remember: he is not buying your voice. He is timing it.
...
**HARUTO:** They clocked a Skyline doing 289 on the Yokohane. 289. The thread is calling him the last king and calling you “the girl on the list” — third most-viewed clip this week, behind a dog and a crash. Kenji says the fast ones never get caught, only the visible ones. So: how visible do we want the last runs to be?
...
**NARRATOR:** Forty minutes of mercy before the city wakes. The Supra idles at the ramp like a held breath. Kenji is here, against all medical advice and his own stubbornness, holding the stopwatch he has carried since 1987.

**KENJI:** The club had one blessing. Not "go fast" — nobody needed blessing for that. We said: COME HOME. Call it clean, drive it whole, come home. Girl — you are the voice of this run. Make it the last thing this road ever hears from us, and make it sound like us.

**HARUTO:** (checking the map, not quite steady)
...
1. **"Come home to me. That was always the deal. Call it in."**
   → Haruto: (fist against the roll cage, and something soft underneath it)
   ...
   _stats: driverTrust +25 · mentalStress -10 · legacy +15_
2. **"One last call, in the old club's format. The way Reina would have read it."**
   → Kenji: (the stopwatch arm trembles, not from age)
   ...
   _stats: legacy +25 · teamRespect +20 · grit +10_

#### After the stage · scene 1 — OKABE GARAGE · ONE YEAR LATER

**NARRATOR:** The list took Shimamoto's crew and two others. Never yours. The shop stands: half legal classics now, Kenji's crest framed where the fire marshal can see it. Your clip from the tunnel mouth has four million views and a title you never chose: THE VOICE OF THE WANGAN. The red coupe out back still does not run. He still refuses to fix it. You still know better than to ask.

**KENJI:** Sit. The polite kids in the back bay think a boost gauge is technology. I let them. Meanwhile — a university in Kyoto wrote. They want the club tapes. ALL of them. Thirty years of calls, catalogued, taught. Reina's voice, my engines' history, your four million. The archive of a thing everyone said was a myth.

**KENJI:** I am seventy-two and the heart keeps its own schedule now. So: the tapes go to Kyoto. The crest goes in the case. And you — the sign above the bench says OKABE &amp; CO. It should say OKABE &amp; DAUGHTER. Not blood. Better than blood. Refuse fast or accept fast, girl. I hate saying sentimental things twice.

**Choices:**

1. **Accept. The name stays, the voice teaches, the religion continues.**
   → Kenji: (hands over the stopwatch — 1987 to now, no ceremonies)
   ...
   _stats: legacy +30 · teamRespect +20 · grit +15_
2. **"Keep the shop its own thing. I was never its daughter — I was its voice. Different inheritance."**
   → Kenji: (a long, real laugh, then a cough, then a nod)
   ...
   _stats: legacy +25 · mentalStress +10 · grit +20_

---

# DUST AND HONOR — Dakar / Roadbook

*Theme: Roadbook (sand & diesel)*

**Cast:** You (mud-flat racer) · Tarek Benhima (mechanic) · Amine Diallo (23, driver) · Viktor Reznik (rival)

## Route: MALE CO-DRIVER

### Intro — SAHARA FRINGE · BIVOUAC AT DUSK

You learned to read a road the way farm kids learn rain —
...
#### Before the stage · scene 1 — BIVOUAC · TENT 7 · 05:30

**NARRATOR:** The bivouac smells like diesel, sand, and strong coffee made by people who have already been awake for an hour. Tarek Benhima is sixty-three and built like the Atlas mountains: patient, permanent, and full of old snowmelt. He pours two glasses of coffee and does not ask if you want one.

**TAREK:** Three years since the crash. You have rebuilt tractors, tuned my daughter's death-trap scooter, and refused every seat I offered. So. New tactic. I am not offering you a seat. I am offering you a job reading roads for Amine — the kid who bought a Hilux with rally money he does not have. He cannot navigate a parking structure. You can. Nobody says you must love it.

**YOU:** The last time I sat in a rally car, the coroner came to the funeral. I was in the hospital for the service. You know this. You pulled me out.

**TAREK:** I know every piece of it. I carried the pieces. Listen to me, boy — the road did not kill Youssef. The NOTE did. A wrong call, half a corner early. If the road was guilty, no one would ever drive again. You know roads better than grief does. Give the grief the funeral and give me one season. One.

**Choices:**

1. **"One season. And Amine learns that my calls are not suggestions."**
   → Tarek: (drinks his coffee like a contract signing)
   ...
   _stats: driverTrust +10 · teamRespect +10 · grit +5_
2. **"I will read for him. But I write my own pace notes. Nobody touches the book."**
   → Tarek: (a slow, mountain-moving nod)
   ...
   _stats: teamRespect +15 · grit +10_

#### Before the stage · scene 2 — SERVICE PARK · HILUX BAY 3 · 19:45

**NARRATOR:** Amine Diallo is twenty-three and enthusiastic in the specific way of people who have never been hospitalized for their hobby. The Hilux is spotless. His driving suit has sponsor patches for companies that have not paid yet.

**AMINE:** There he is! The legend of sector four! Tarek told me what you did before — not the crash part, the other part, the reading part. Look, I know I am a handful. But I am a FAST handful. You keep the notes honest, I keep the throttle honest. Deal?

**YOU:** My notes keep you alive. The throttle keeps you honest. We do not swap jobs. That is the whole deal, and it is not negotiable.

**Choices:**

1. **"Say it back to me so I know you actually heard it."**
   → Amine: (wounded, then laughing)
   ...
   _stats: driverTrust +15 · grit +5_
2. **"Deal. One more thing: you drive the stage, but I own the pace."**
   → Amine: (chews on it, visibly)
...
#### After the stage · scene 1 — BIVOUAC · TENT 7 · 21:30

**NARRATOR:** The Hilux comes home with mud to the door handles and both fenders attached. Tarek inspects it like a father checking a toddler for chickenpox. Amine is doing victory laps around the tents, narrating his own highlights.

**TAREK:** He held it together on the rocky descent. Fourteen months ago a driver spun there and took a spectator's fence with him. Amine held it. Your book held him. So. The coffee is terrible, the couscous is worse, and you sat in the seat and came back from it. All three facts are noted in the ledger I keep that nobody is allowed to read.

**YOU:** I heard my own voice go quiet on stage six. Not from fear. From focus. First time since the crash. I do not know what to do with that.

**TAREK:** Do nothing. It is not yours to manage. Focus is what the road gives back to people who respect it. Tomorrow it may not come. The day after, it will. That is the deal with roads. They forgive nothing and they forget everything, which makes them better company than people.

**Choices:**

1. **"Thank you. For pulling me out. I never finished saying it."**
   → Tarek: (waves it off with a hand the size of a hubcap)
   ...
   _stats: driverTrust +5 · mentalStress -15 · teamRespect +10_
2. **"The ledger. Youssef's page. Tell me what it says."**
   → Tarek: (long silence. The fire pops. Somewhere a generator sighs.)
   ...
   _stats: grit +15 · mentalStress -5 · teamRespect +15_

#### After the stage · scene 2 — SERVICE PARK · THE RIG TENT · 22:10

**NARRATOR:** Viktor Reznik's team parks two bays down like an unexploded shell. Reznik is on his fourth navigator in two seasons. The last one quit mid-stage and thumbed a ride with the medical truck. The tent next to yours has started charging his fans for shade.

**AMINE:** Reznik just posted about us. "Sponsor-subsidized farm boys and their gravedigger reader." Nine thousand likes. There is a whole sub-thread about the crash. About you. I have not looked. Yousef's cousin looked for me and said it is bad. Should we say something back?

**Choices:**

1. **"The road says it back to Reznik every stage. Let it do the talking."**
   → Tarek: (approving, from the engine bay)
   ...
   _stats: grit +10 · teamRespect +10 · mentalStress -5_
2. **"One reply. Calm. Then silence. His mouth writes checks his co-drivers cash."**
   → Your reply — "his last three navigators paid his mouth's bills; we pay in times" — goes mildly viral in rally circles. Reznik posts a video staring into the camera for forty seconds. It helps nobody, least of all him.
   ...
   _stats: reputation +15 · grit +5_

### Chapter 2

#### Before the stage · scene 1 — BIVOUAC · WIND 60KM/H · 04:15

**NARRATOR:** The harmattan arrived overnight, erasing the roadbook's careful ink with a horizon of orange. The organizers have delayed the start twice. Half the paddock is napping. Reznik's crew is loading like the storm is a personal insult.

**TAREK:** Thirty-eight years of desert and it still makes the first move every morning. Listen. The storm route runs through the erg — deep sand, no visual references, navigation by compass and faith. Officials will let anyone stupid enough to start. Reznik will start. His navigator has nine days' experience and a twitter account.

**AMINE:** And us? I am not afraid of sand. I am afraid of being BORING in sand. Tell me we are going. Tell me the book has a plan.

**TAREK:** The book does not have a plan. The book is PAPER. The reader has a plan or does not. — Both of them look at you. The wind hums against the tent like it also wants to know.

**Choices:**

1. **"We go. Compass headings, kilometer discipline, zero heroics. Slow is smooth."**
   → Tarek: (the nod he gives engines that will survive)
   ...
   _stats: driverTrust +15 · teamRespect +15 · grit +10_
2. **"We wait for the window. The erg keeps what it takes. No stage is worth a body."**
   → Amine: (jaw works, then — surprisingly — nods)
   ...
   _stats: grit +10 · mentalStress -10 · reputation +5_

#### Before the stage · scene 2 — SERVICE PARK · ALCOHOL UNKNOWN · 23:40

**NARRATOR:** A stage win changed Amine. Not the trophy — the COMMENTS. Sponsors emailing directly. Paddock people calling him "the natural." Natural things, he has started suggesting, do not need co-drivers managing their pace. He has said it twice today, both times joking, neither time entirely.

**AMINE:** Hey. Hey. Don't make the face. I am just saying — Reznik drives ALONE in the dunes section, no calls, full send, and the clips go everywhere. My clips have me doing... careful. Careful is for people who are not the natural. — He is drunk in the specific way that is really just fear wearing confidence's jacket.

**Choices:**

1. **"Reznik drives alone because his readers keep leaving. That is not freedom. That is a vacancy."**
   → Amine: (long silence. The joke drains out of him like oil.)
   ...
   _stats: driverTrust +20 · teamRespect +10 · mentalStress -5_
2. **Let him talk. All of it. Then say nothing and hand him the crash photo.**
   → You show him the only photo of Youssef's car you kept: not the wreck — the car, two days before, golden in the dust, both of them grinning on the hood.
   ...
   _stats: driverTrust +25 · mentalStress -10 · grit +5_

#### After the stage · scene 1 — KM 214 · WRECKAGE ON THE FAST SECTION · 16:20

**NARRATOR:** The car is Reznik's. The dust has not settled enough to lie about the angle. His tenth navigator in two seasons is out of the cabin, walking in circles, holding his own wrist. Reznik is still belted in, conscious, and shouting about suspension travel.

**AMINE:** (at race speed, past the wreck)
...
1. **"Stop. Always stop. Book the stage goodbye."**
   → You stop. Amine splints the navigator's wrist with a tire gauge and a bonnet strap while Tarek's radio calls it in. Reznik, absurdly, keeps shouting times at his wrecked suspension like the numbers will fix it.
   ...
   _stats: reputation +20 · teamRespect +15 · grit +10_
2. **"Report position, keep race pace. Stopping is for the medical car."**
   → You report the wreck precisely — km marker, injuries apparent, vehicle state — and hold race pace. The medical car arrives four minutes later than it would have. Sami's wrist is worse for it. Nothing life-changing. Something trust-changing.
   ...
   _stats: driverTrust +5 · reputation -10 · mentalStress +15_

#### After the stage · scene 2 — BIVOUAC · TENT 7 · SATELLITE PHONE · 05:50

**NARRATOR:** The satellite phone rings at 05:50, which is when bad news schedules itself in the desert. Youssef's mother. She has never once called angry. Today her voice is sandpaper and careful.
...
**YOUSSEFS_MOTHER:** I have read what they write. I do not believe strangers. So I ask the man who was in the seat: my son's crash — was it the note, or was it the road? You have run from this answer for three years. I am old now. I am asking you to spend it.

**Choices:**

1. **"The note. Mine. Half a corner early and he trusted it with everything. I have driven three years so it never happens twice."**
   → A silence so long the generator cycles twice.
   ...
   _stats: grit +25 · mentalStress -20 · legacy +10_
2. **"It was both. The note was early AND the road was slick. I have never been able to separate them, and I have tried every night for three years."**
   → Youssef's mother: ...Both. Yes. His father says the road. The team says the conditions. You say both. Three answers, three funerals of the same day. — A breath that has been held for three years, half-released. Come for tea after the rally. Not to be forgiven. To drink tea. Forgiveness is God's department; tea is ours.
   _stats: mentalStress -10 · grit +10 · teamRespect +5_

### Chapter 3

#### Before the stage · scene 1 — STAGE ROAD · 400 KM TO BIVOUAC

**NARRATOR:** Liaison days look like rest and are not. Four hundred kilometres of escort road with the mechanic truck in front of you and Reznik’s convoy haunting the mirrors. Tarek spends them the way he spends everything — working: retorquing, re-tiling the fuel math, re-reading Youssef’s old roadbook like it is scripture with grease on it.

**TAREK:** The desert does not care about points. It cares whether you respect it. Youssef wrote in the margins of every stage: “the dune decides — your job is to be ready for its decision.” Amine reads speed. Tonight, quiz him on the sculls. Make him see the hazard before the hazard sees him.

**Choices:**

1. **“Drill the danger words until Amine hates me for it.”**
   → Tarek: (nods once — the good nod)
   ...
   _stats: grit +15 · driverTrust -5_
2. **“Back off. He drives better loose than lectured.”**
   → Tarek: (a long silence, then)
...
#### After the stage · scene 1 — BIVOUAC · REZNIK’S ROW · 21:30

**NARRATOR:** Word travels bivouac-fast: Reznik burned through another navigator — his ninth this season — and their manager offered you the seat before the tent flap closed. The number they are muttering would fund the school Tarek keeps sketching on napkins. Amine is pretending to sleep, badly.

**AMINE:** You should take it. — No, hear me. If I kept crashing co-drivers, you would tell me the truth, so here is mine: that seat is a rocket with a chewing-gum shift. It eats voices. But I will not beg you to stay either — that is not what we are. Just tell me which way I should feel about it.

**Choices:**

1. **“We stay. Amine and me to the finish, however it lands.”**
   → Amine: (exhales like a man surfacing)
   ...
   _stats: driverTrust +20 · teamRespect +10 · reputation -5_
2. **“I hear the rocket. Give me one stage to decide.”**
   → Amine: (a slow nod, jaw tight)
...
#### Before the stage · scene 1 — FINAL ERG · START LINE · 06:10

**NARRATOR:** The last stage: 340 kilometers of dune field between you and the finish ramp in town. Second overall overall if you hold position. First in class regardless. Amine has not slept — not from fear, from the specific electricity of a man who can taste the ramp.

**TAREK:** The Hilux is perfect. I have signed my name to every bolt on it, which at my age is a love letter. The dunes will do what they do. Amine — drive the car you were given, not the one you dream about. Boy — read the road you SEE, not the one you remember. And both of you: the finish ramp is for the crowd. Come home for us.

**AMINE:** (quiet, helmet under one arm)
...
1. **"Read you home. 340 kilometers. One book. Both hands on the wheel of my voice."**
   → Amine: (grin like sunrise)
   ...
   _stats: driverTrust +25 · teamRespect +15 · legacy +10_
2. **"We drive it for Youssef. His name in the book, our names on the ramp."**
   → You write it on the glovebox in marker where only the two of you will see: YOUSSEF, WE FINISHED. Amine says nothing. Amine drives the stage of his life — smooth, patient, gone from reckless the way a fever breaks.
...
**SAMI:** (overhearing, folder clutched)
...
1. **Sign with the works team. Carry the bivouac's lessons to the top of the sport.**
   → Tarek: (no surprise, enormous pride, one bear hug that creaks)
   ...
   _stats: legacy +30 · reputation +20 · teamRespect +10_
2. **Stay. Build the school Tarek will never ask for: teach the desert's readers yourself.**
   → Tarek: (the tea glass stops halfway to his mouth)
   ...
   _stats: legacy +30 · grit +20 · teamRespect +20_

## Route: FEMALE CO-DRIVER

### Intro — SAHARA FRINGE · BIVOUAC AT DUSK

You learned to read a road the way farm kids learn rain — by
...
**NARRATOR:** The bivouac smells like diesel, sand, and strong coffee made by people who have already been awake for an hour. Tarek Benhima is sixty-three and built like the Atlas mountains. He pours two glasses and slides one across before you speak — which means Reza in the next tent has already told him you were coming, which means everyone has been discussing you for at least a day.

**TAREK:** Three years rebuilding tractors. Three years refusing my seats. So: new offer. Amine — the boy who bought a Hilux with money he does not have — needs a reader. Before you say the thing you always say, I will say what I have heard the paddock say: that a girl from the mud flats will make his sponsors nervous. Good, I say. Nervous sponsors negotiate. Confident ones dictate. Sit.

**YOU:** The last time I sat in a rally car, the coroner came to the funeral. I was in the hospital for the service. You know this because you pulled me out of it.

**TAREK:** I know every piece. I carried the pieces. And I will tell you what I have never said: the road did not kill Youssef, and the note did not kill him alone. I signed that suspension. My workshop's torque wrench was the last hand on it. Grief has enough guilt for all of us, girl — stop dining alone at that table. One season. Read for the boy. Let the desert argue with the men who doubt you. The desert wins those arguments every time.

**Choices:**

1. **"One season. And if the sponsors flinch, they can watch from the results board."**
   → Tarek: (drinks like a contract just signed)
   ...
   _stats: driverTrust +10 · teamRespect +10 · grit +10_
2. **"My notes, my book, my pace. Nobody touches any of it. Deal?"**
   → Tarek: (a slow mountain-moving nod)
   ...
   _stats: teamRespect +15 · grit +15_

#### Before the stage · scene 2 — SERVICE PARK · HILUX BAY 3 · 19:45

**NARRATOR:** Amine Diallo is twenty-three and enthusiastic in the specific way of people who have never been hospitalized for their hobby. His Hilux is spotless. When he sees you his face does a thing you have seen a hundred times: surprise, arithmetic about his sponsors, then — thankfully — curiosity winning.

**AMINE:** Okay, full honesty? Tarek said "the best reader in the paddock" and I pictured some gruff sixty-year-old uncle. You are — hm. Not that. Whatever. Doesn't matter. My last two readers quit because I drive like the dunes owe me money. Can your book handle that, or should I slow down before you even get in?

**YOU:** I have read roads through mud that ate whole crews. I was in the seat the day the sport's worst joke got told and I finished the stage on a broken wrist. Your dunes can adjust to my book, or my book will adjust them. Either way you will finish. That is the only promise worth making.

**Choices:**

1. **"Say the deal back so I know you heard it: my notes are law, your throttle is the pen."**
   → Amine: (wounded, then delighted)
   ...
   _stats: driverTrust +15 · grit +10_
2. **"One more term: we do the recce MY way. Twice through, both runs. No shortcuts."**
   → Amine: (groans like a two-stroke at altitude)
...
#### After the stage · scene 1 — BIVOUAC · TENT 7 · PHONE FACE-DOWN · 21:30

**NARRATOR:** The stage highlights went up an hour ago. The frame everyone clipped is you, arm out the window calling a line through the rock garden while the Hilux takes it clean. The caption wars are in full bloom. Half of them say you do not belong. The other half have discovered, in real time, that you do. Amine keeps refreshing. You keep eating.

**AMINE:** Nine thousand comments. NINE. Half of them are in languages I cannot read and the energy is still clear. How do you just — EAT? — He gives up on the phone. Tarek, from the fire: Let her eat. The reading tomorrow needs blood in the stomach, not in the argument. — To you, quieter: Does it get in the helmet? The noise. During the stage. Be honest, I can take it.

**YOU:** Nothing gets in the helmet during a stage. The helmet is where I keep the road. The noise is a parking-lot problem. It can queue like everyone else.

**Choices:**

1. **"Post one reply: the stage times. Nothing else. Every race. Forever."**
   → You do exactly that. No captions, no faces, just stage position after stage position, until the account itself becomes a kind of argument no one can win against a spreadsheet.
   ...
   _stats: reputation +15 · grit +10 · mentalStress -10_
2. **"I say it once, clean, at the finish ramp mic. Then silence for the season."**
   → At the ramp: "The seat is a workplace, not a debate. My work is the book. Judge the book." — Then you say nothing for six weeks while the clip does three circuits of the internet, translating itself.
   ...
   _stats: reputation +10 · grit +15 · legacy +5_

#### After the stage · scene 2 — SERVICE PARK · THE RIG TENT · 22:10

**NARRATOR:** Viktor Reznik's team parks two bays down like an unexploded shell. He is on his fourth navigator in two seasons — the last one quit mid-stage and thumbed a ride with the medical truck. Tonight his team has been spreading a specific rumor: that you only have a seat because Tarek "collects charity cases."

**AMINE:** He said it at scrutineering, in front of the FIA steward and everything. And his navigator — the new one, Sami, nineteen, seems decent actually — Sami just stood there staring at his shoes like he wanted to be anywhere else. Should I do something? I want to do something. I have a tire iron and poor impulse control.

**Choices:**

1. **"No tire irons. Sami stands there because he already knows the truth — ask him about the shoe-staring."**
   → You find Sami at the water truck. Nineteen, second-ever stage, wrists full of bruise-watch. "He calls me 'the insurance requirement,'" Sami says, flat. "You stopped for Reznik at KM 214 last season. Everyone in the junior paddock knows who stops." — By morning, two more junior navigators have asked, quietly, if you are taking students. The rumor does not survive contact with the people it was about.
   _stats: reputation +15 · grit +10 · teamRespect +10_
2. **"Beat him by two minutes on rock and let the stage make the joke."**
   → You write the rockiest stage of the season like a legal document. Amine drives it like a man possessed by competence. Two minutes, twelve seconds. At the finish, the timekeeper — an old woman who has seen forty years of this sport — reads your gap aloud twice, slowly, into her radio, for no technical reason whatsoever.
   ...
   _stats: reputation +15 · grit +10_

### Chapter 2

#### Before the stage · scene 1 — BIVOUAC · WIND 60KM/H · 04:15

**NARRATOR:** The harmattan arrived overnight, erasing the roadbook's careful ink with a horizon of orange. The start is delayed twice. Half the paddock naps. Reznik's crew loads like the storm is a personal insult, and his brand-new navigator — a quiet kid named Sami, on his second ever stage — looks like a man being loaded into a cannon.

**TAREK:** The erg in this soup: deep sand, no visual references, navigation by compass and faith. Officials will let anyone stupid enough to start. Reznik will start. The question, as always, is not the storm. It is what we decide the storm is. Both of you — reader's call. This one has always been yours.

**AMINE:** For the record, whatever you decide, I am in. But if we go, I want the bold headings. Your bold headings are the only handwriting I trust at speed.

**Choices:**

1. **"We go. Compass headings in bold, kilometer discipline, zero heroics. Slow is smooth."**
   → Tarek: (the nod he gives engines that will survive)
   ...
   _stats: driverTrust +15 · teamRespect +15 · grit +10_
2. **"We wait for the window. The erg keeps what it takes. No stage is worth a body — especially his."**
   → Amine: (jaw works, then nods — the surprise is that it surprises you)
   ...
   _stats: grit +10 · mentalStress -10 · reputation +10_
...
1. **"Reznik drives alone because his readers keep LEAVING. That is not freedom, that is a vacancy. Ninth navigator, Amine. Ninth."**
   → Amine: (the joke drains out of him like oil)
   ...
   _stats: driverTrust +20 · teamRespect +10 · mentalStress -5_
2. **Let him talk all of it. Then hand him the golden photo — you and Youssef on the hood, two days before.**
   → Amine: (long, long silence, photo in both hands)
...
**NARRATOR:** The car is Reznik's. The dust has not settled enough to lie about the angle. His newest navigator — Sami, nineteen, second-ever stage — is out of the cabin walking in circles, holding his own wrist. Reznik is belted, conscious, shouting about suspension travel.
...
1. **"Stop. Always stop. Splint the kid, call it in, book the stage goodbye."**
   → You stop. Amine splints Sami's wrist with a tire gauge and a bonnet strap while you call the wreck in with coordinates so clean the medical car later asks who wrote them. Reznik keeps shouting times at his own wrecked suspension.
   ...
   _stats: reputation +20 · teamRespect +15 · grit +10_
2. **"Report it perfect — coordinates, injuries, state — and hold race pace. Rules are rules."**
   → You report the wreck with textbook precision and hold race pace. The medical car arrives four minutes later than it would have. Sami's wrist is worse for it. Nothing life-changing. Something trust-changing.
...
**NARRATOR:** The satellite phone rings at 05:50, which is when bad news schedules itself in the desert. Youssef's mother. She has never once called angry. Today her voice is sandpaper and care.
...
**YOUSSEFS_MOTHER:** I have read what they write. I did not believe strangers, so I came to ask the woman who was in the seat. My son's crash — the note, or the road? You have run from this answer three years. I am old, and I have brought oranges, and I am asking you to spend the truth on me.

**Choices:**

1. **"The note. Mine. Half a corner early, and he trusted it with everything. Three years I have driven so it never happens twice."**
   → She sits down on the tent's sand anchor like her legs have finished with standing.
   ...
   _stats: grit +25 · mentalStress -20 · legacy +10_
2. **"Both. The note was early AND the road was slick, and I have tried every night for three years to separate them. They will not separate. That is the truth, and it is the only one I have."**
   → Youssef's mother: ...Both. — She looks at the oranges, then the horizon, then you. His father says the road. The team says the conditions. You say both. Three answers. Three funerals of the same day. — A long breath, three years held, half-released. Come for tea after the rally. Not for forgiveness. Forgiveness is God's department. Tea is ours. Bring your appetite and no apologies. — She leaves the oranges. The tent smells like citrus for two days. Nobody minds.
   _stats: mentalStress -10 · grit +15 · teamRespect +5_
...
**TAREK:** The desert does not care about points. It cares whether you respect it. Youssef wrote in the margins of every stage: “the dune decides — your job is to be ready for its decision.” Amine reads speed. You read the sand better than anyone I have trained. Quiz him on the sculls tonight — make him see the hazard before the hazard sees him.
...
**AMINE:** You should take it. — No, hear me. You always tell me the truth, loudly, so here is mine: that seat is a rocket with a chewing-gum shift. It eats voices — even ones the paddock finally learned to spell. But I will not beg you to stay either. Just tell me which way I should feel about it.
...
1. **"Read you home. And when we land on that ramp, we land as a crew. All four of us — you, me, Tarek, and the man who taught me the road."**
   ...
   _stats: driverTrust +25 · teamRespect +15 · legacy +15_
2. **"We drive it for Youssef. His name in the book, our names on the ramp, the school in his memory."**
   → You write it on the glovebox in marker: YOUSSEF — FINISHED. Amine drives the stage of his life. At the ramp, the journalist asks about the ink. The answer — "we finished it for the man who taught our reader the road" — becomes the most-shared piece of rally media of the season.
...
1. **Sign with the works team — and bring the book club with you as your project.**
   → Tarek: (no surprise, enormous pride, one bear hug that creaks)
   ...
   _stats: legacy +25 · reputation +20 · teamRespect +15_
2. **Stay. Build the school. The desert invented you, so the school stays in the desert.**
   → Tarek: (the tea glass stops halfway to his mouth)
...
## Factions (classic WRC politics)

### Factory Teams

*Success comes from tradition, hierarchy, and controlled environments. Racing should be about engineering excellence, not individual heroics.*
...
- **Internal contradiction:** They claim to value innovation but fire anyone who deviates from established procedures. They preach teamwork but reward individual engineers who claim credit for collective work.
- **Who benefits / who suffers:** Corporate engineers,Sponsors,Shareholders vs Privateer teams,Creative mechanics,Young drivers

### Privateers

*Racing is about human skill and adaptation, not corporate budgets. Anyone with talent should have a chance, regardless of funding.*
...
- **Internal contradiction:** They preach freedom but often rely on factory cast-off parts. They claim to be about talent but still need money to compete.
- **Who benefits / who suffers:** Talented but underfunded drivers,Creative mechanics,Local racing communities vs Sponsors seeking guaranteed exposure,Engineers who prefer structure,Risk-averse investors

### The Progressives

*Racing must evolve responsibly. Speed without responsibility is meaningless. Safety and innovation should be balanced with human cost.*
...
- **Internal contradiction:** They advocate for safety but profit from building safer cars. They claim to protect drivers but sometimes prioritize their own regulatory authority over actual driver input.
- **Who benefits / who suffers:** Safety engineers,Insurance companies,Regulatory bodies vs Purist drivers,Traditionalists,Fans who love danger

### The Old Guard

*Racing is about danger, bravery, and the absolute limit. Safety regulations have made it sterile. Real racing requires the possibility of death.*
...
- **Internal contradiction:** They claim to value courage but often take unnecessary risks that endanger others. They preach tradition but many of them made their careers by breaking with tradition.
- **Who benefits / who suffers:** Purist fans,Historians,Drivers who thrive on danger vs Safety advocates,Modern engineers,Drivers with families

### The Media Machine

*Racing exists to entertain. Competition is secondary to the story. Dramatic conflicts, personalities, and narratives matter more than raw performance.*
...
- **Internal contradiction:** They claim to serve the fans but often create artificial drama. They preach authenticity but manufacture narratives for maximum engagement.
- **Who benefits / who suffers:** Sponsors,Casual fans,Drivers who court media attention vs Private drivers,Teams who avoid drama,Purist racing enthusiasts
