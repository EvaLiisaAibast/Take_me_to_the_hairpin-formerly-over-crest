// Custom Track Editor - Leaflet.js + OpenStreetMap integration
...
const CustomTrackEditor = {
  ...
  addDrawControls() {
    ...
    if (markerBtn) {
      markerBtn.addEventListener('click', () => this.addMarkerMode());
    }
  },
  ...
  toggleDrawMode() {
    ...
    if (this.isDrawing) {
      ...
      this.map.on('click', (e) => this.addRoutePoint(e.latlng));
    } else {
...
// Initialize editor when screen is shown
